    ...
    <form action="/continue/declaration" method="post">
      ...
      <ContentItem.B_30_15>
        ...
        the change happening."
            ...
            >
              I, or the operator, will notify food authorities of any
              significant changes to the business activity, including closure,
              within 28 days of the change happening.
            </Checkbox>
        ...
        establishment."
            ...
            >
              I, or the operator, understands the operator is legally
              responsible for the safety and authenticity of the food being
              produced or served at this establishment.
            </Checkbox>
          </MultiChoice>
        </ContentItem.B_30_15>
      </ContentItem.B_30_15>
