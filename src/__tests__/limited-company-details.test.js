import LimitedCompanyDetails from "../../pages/limited-company-details";
...
describe("<LimitedCompanyDetails />", () => {
  it("renders without crashing", () => {
    const wrapper = shallow(<LimitedCompanyDetails />);
    expect(wrapper.length).toBe(1);
  });

  it("matches the previous snapshot", () => {
    const tree = renderer
      .create(<LimitedCompanyDetails validatorErrors cumulativeAnswers />)
      .toJSON();
  ...
  //   it("renders", () => {
  //     const wrapper = mount(
  //       <LimitedCompanyDetails validatorErrors cumulativeAnswers />
  //     );
